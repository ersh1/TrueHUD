...
namespace TRUEHUD_API
{
	...
	public:
		...
		[[deprecated]]
		virtual APIResult RequestPlayerWidgetBarColorsControl(SKSE::PluginHandle a_myPluginHandle) noexcept = 0;
		...
		[[deprecated("Use OverrideBarColor/OverrideSpecialBarColor instead")]]
		virtual APIResult OverridePlayerWidgetBarColor(SKSE::PluginHandle a_myPluginHandle, PlayerWidgetBarType a_playerWidgetBarType, BarColorType a_colorType, uint32_t a_color) noexcept = 0;

		[[deprecated("Use RevertBarColor/RevertSpecialBarColor instead")]]
		virtual APIResult RevertPlayerWidgetBarColor(SKSE::PluginHandle a_myPluginHandle, PlayerWidgetBarType a_playerWidgetBarType, BarColorType a_colorType) noexcept = 0;
